...
type Module = typeof import("../webhooks.app.customers-data-request.js")

type Info = GetInfo<{
  file: "routes/webhooks.app.customers-data-request.jsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../webhooks.app.customers-data-request.js");
}];
